# From https://github.com/Fattoresaimon/I2CEncoderV2.1/tree/master/Python%20Raspberry%20Library
# https://d3s5r33r268y59.cloudfront.net/datasheets/17550/2019-07-26-20-35-08/EncoderI2CV2.1_v1.0.pdf
...
# Class costructor
    ...
    def __init__(self, bus, add):
        self.i2cbus = i2c_device.I2CDevice(bus, add)
...
# Send to the encoder 1 byte #
    def writeEncoder8(self, add, value):
        self.temp[0] = add # Co=1, D/C#=0
        self.temp[1] = value
        self.i2cbus.write(self.temp)    
        return -1
